...
### What's Pending ❌
- **`ALFRED_RESTRUCTURE_ROADMAP_v2.md` Phases 5–7** (one per session, in order): Trends month navigation/forecast/archive rework, full capture heatmap by `viewMonth`, optional FAB long-press
